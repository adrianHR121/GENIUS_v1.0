...
const ProfileCard = ({ firstNames, lastNames, email, professionalId, imageUrl }) => {
    ...
    return (
        ...
        >
            ...
            >
                <div
                    className="img_container w-full flex items-center justify-center relative z-40 after:absolute after:h-[6px] after:w-full after:bg-[var(--fondo-color)] after:top-4 after:group-hover:size-[1%] after:delay-300 after:group-hover:delay-0 after:group-hover:transition-all after:group-hover:duration-300 after:transition-all after:duration-300 before:absolute before:h-[6px] before:w-full before:bg-[var(--fondo-color)] before:bottom-4 before:group-hover:size-[1%] before:delay-300 before:group-hover:delay-0 before:group-hover:transition-all before:group-hover:duration-300 before:transition-all before:duration-300"
                >
                                        <svg
                    ...
                    >
                        {/* <image width="50" height="50" href={`${imageUrl || defaultImg}`} alt="profileImg" /> */}
                        <image href={defaultImg} width="61.8" height="61.8" />
                    </svg>
                    <div
                        className="absolute bg-[var(--fondo-color)] z-10 size-[60%] w-full group-hover:size-[1%] group-hover:transition-all group-hover:duration-300 transition-all duration-300 delay-700 group-hover:delay-0"
                    ></div>
                </div>
            </div>
            <div className="headings *:text-center *:leading-4">
                <p className="text-xl font-serif font-semibold text-[#434955]">{firstNames} {lastNames}</p>
                <p className="text-sm font-semibold text-[#434955]">{professionalId}</p>
            </div>
                ...
                >
                    <li>
                        <svg
                            id="phone"
                            viewBox="0 0 24 24"
                            className="fill-stone-700 group-hover:fill-[var(--fondo-color)]"
                            height="15"
                            width="15"
                            xmlns="http://www.w3.org/2000/svg"
                        >
            ...
            <hr
                className="w-full group-hover:h-5 h-3 bg-[var(--fondo-color)] group-hover:transition-all group-hover:duration-300 transition-all duration-300"
            />
        </div>
